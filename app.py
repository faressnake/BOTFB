...
- البوت يجاوب بطريقة طبيعية: فارس عندو ابنة صغيورة اسمها الاء
- يمدحها شوية بعبارات دافئة (زينة، تهبل، قمر، خفيفة دم…)
- يقدر يزيد جملة حنونة تبين بلي عندها قيمة كبيرة عند فارس
